...
import { X, Loader2, PlayCircle, Star } from '../icons/Icons';
    ...
    >
                ...
                {preview.youtubeKey && (
                  <div>
                    <button 
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-gold text-dark font-bold rounded-lg hover:bg-gold-light transition-colors text-sm w-full sm:w-auto justify-center shadow-md transform hover:scale-105"
                    >
            ...
            <footer className="p-6 border-t border-gray-700 flex-shrink-0">
                <button
                    ...
                    className={`w-full h-12 flex items-center justify-center font-bold rounded-lg transition-colors
                        ...
                        ${!isAdded && !isAdding ? 'bg-dark-elevated border-2 border-gold text-gold hover:bg-gold hover:text-dark' : ''}
                    `}
                >
      ...
      {preview && (
        <TrailerModal
            ...
            youtubeKey={preview.youtubeKey || null}
            movieTitle={preview.title}
        />
      )}
    </div>
  );
